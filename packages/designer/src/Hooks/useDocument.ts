...
import { QuickFormDesignerState } from "../Types/QuickFormDefinition";

declare module "@eavfw/quickform-core" {
    interface QuickFormQuestionDefinition {
        /**
...
export const useDocument = (entityName: string, attributeName: string, designerLocale?: Locale) => {
    ...
    const [quickformpayload, updateQuickFormPayload] = useState<QuickFormDefinition>(JSON.parse(old ?? JSON.stringify({
        intro: {
        },
        submit: {
        },
