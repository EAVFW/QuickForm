...
import { ValidationResult } from "./defaults";
...
export type InputValidator = <TProps extends InputPropertiesTypes>(questionModel: QuestionModel<TProps>) => ValidationResult;
